...
public class RequestFile implements Serializable {
	...
	private String file_target_space;// 文件保存位置
	...
	public String getFile_target_space() {
		return file_target_space;
	}

	public void setFile_target_space(String file_target_space) {
		this.file_target_space = file_target_space;
	}
